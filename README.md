...
If the library is not working as expected, you may need to add the following line to your `.npmrc` file.
```npmrc
...
![Image](https://github.com/fahimkk/react-recurring-job/blob/main/src/assets/weeklyStyled.png)
